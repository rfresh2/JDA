...
public class RoleColors implements SerializableData {
    ...
    public Color getPrimary() {
        return primary == Role.DEFAULT_COLOR_RAW ? null : Color.of(primary);
    }
    ...
    public Color getSecondary() {
        return secondary == Role.DEFAULT_COLOR_RAW ? null : Color.of(secondary);
    }
    ...
    public Color getTertiary() {
        return tertiary == Role.DEFAULT_COLOR_RAW ? null : Color.of(tertiary);
    }
